<?php
  ...
  if (isset($_POST['perbarui']))
  {
    ...
    $status        = mysqli_real_escape_string($koneksi->db, $_POST['status']);

    $result = $pengguna->editUser($id_pengguna, $sandi, $nama, $status);
          ...
          <form name="frmUbahPengguna" method="POST" action="">
            ...
            <div class="form-group">
              ...
              <select id="status" class="form-control" name="level">
                <?php
                  $data_selection = $pengguna->getSelectedStatus($data_pengguna['status']);
